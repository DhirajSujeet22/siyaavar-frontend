...
//   const currentOrder = useSelector(selectCurrentOrder);
  ...
  const totalAmount = GetAddToCart.reduce(
    (amount, cart) => cart.product * cart.quantity + amount,
    0
  );
  ...
  return (
    <>
      ...
      {/* {paymentMethod === "cash" && <Navigate to={`/order_success`} />}
      {paymentMethod === "card" && <Navigate to={`/stripe_checkout`} />} */}
      <>
        {status ? (
          <LoadingSpinner />
        ) : (
                            ...
                            <div className="ml-4 flex flex-1 flex-col">
                              <div>
                                <div className="flex justify-between text-base font-medium text-gray-900">
                                  ...
                                  <p className="ml-4">₹ {cartInfo.product}</p>
                                </div>
