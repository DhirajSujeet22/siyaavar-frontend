  ...
  return (
    <>
      <>
        ...
        />
        <div className="min-w-screen min-h-screen bg-blue-100 flex items-center p-5 lg:p-10 overflow-hidden relative">
          <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
            <div className="w-full md:w-1/2">
              <div className="mb-10 lg:mb-20">
                <img src="https://i.imgur.com/HfWWL7R.png" alt="Our Company" />
              </div>
              <div className="mb-10 md:mb-20 text-gray-600 font-[500]">
                <h1 className="font-black uppercase text-3xl lg:text-5xl text-[rgb(123_151_235)] mb-10">
                  You seem to be lost!
                </h1>
              ...
              <div className="mb-20 md:mb-0">
                <Link to="/">
                  <button className="text-lg outline-none focus:outline-none transform transition-all hover:scale-110 text-red-500 text-[2.1rem] font-bold hover:text-yellow-600">
