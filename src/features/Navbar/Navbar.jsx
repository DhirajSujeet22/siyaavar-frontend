...
import { LuUser, LuHeart, LuUserCheck } from "react-icons/lu";
                ...
                <div className="flex h-[5rem] items-center justify-between">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:block">
                      <div className="ml-10 flex leading-[4rem] items-baseline space-x-4 relative">
                        {navigation.map((item) => (
                          <div key={item.name} className="relative group">
                            ...
                            {item.children && (
                              <div className="absolute w-[30rem] z-50 top-[4rem] left-0 hidden group-hover:block bg-[#f8ecd6] rounded-lg shadow-lg">
                                <div className="py-2">
                    ...
                    <div className="flex items-center gap-[0.5rem]">
                      ...
                      <Link to="/cart">
                        <div className="relative mt-2">
                          <button
                            type="button"
                            className="relative rounded-full bg-transparent p-1 text-black focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 flex items-center justify-center"
                          >
                            <LuHeart className="h-6 w-6" aria-hidden="true" />
                          </button>
                          {GetAddToCart && GetAddToCart.length > 0 && (
                            <span className="absolute -top-1 -right-1 flex items-center justify-center h-5 w-5 rounded-full bg-orange-400 text-xs font-bold text-yellow-800">
                              {GetAddToCart.length}
                            </span>
                          )}
                        </div>
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5 gap-3">
                    ...
                    <Link to="/cart">
                      <button
                        type="button"
                        className="relative mt-2 rounded-full bg-transparent p-1 text-black hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                      >
                        <span className="absolute -inset-1.5" />
                        <LuHeart className="h-6 w-6" aria-hidden="true" />
                        {GetAddToCart && GetAddToCart.length > 0 && (
